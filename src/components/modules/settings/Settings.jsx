	...
	return <div className="layout" style={{background: 'white'}}>
		<div className="main__content centerwidth verticalcenter-2">
			<div className="settings">
				...
				<Link className="button outline" to="/settings/deleteAccount/"><div className="icon trash"><FontAwesomeIcon icon={faTrashCan} /></div> Delete Account <FontAwesomeIcon icon={faChevronRight} /></Link>
