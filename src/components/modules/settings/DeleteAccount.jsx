...
const footerContent = (
  ...
  return (
    ...
    <div className="settings__card">
        <h4 className='internal mb-2 text-gray'>Disclaimer: Account Deletion</h4>
        <p className='text-left mb-2'>By deleting your account, you agree to the following:</p>
        <ul className='text-left ml-1'>
            <li className='mb-1'><b>Permanent Deletion:</b> Your account and all associated data will be permanently removed and cannot be recovered.</li>
            <li  className='mb-1'><b>Loss of Access:</b> You will lose access to all services, content, and features linked to your account.</li>
            <li  className='mb-1'><b>Data Responsibility:</b> Ensure you back up any data you want to keep, as we are not liable for any loss of data.</li>
            <li  className='mb-1'><b>Outstanding Transactions:</b> Resolve any pending transactions or issues before deletion.</li>
        </ul>
       ...
       />
       <Dialog header="Are you sure?" visible={visible} style={{ width: '50vw', textAlign: 'center' }} onHide={() => {if (!visible) return; setVisible(false); }} footer={footerContent}>
