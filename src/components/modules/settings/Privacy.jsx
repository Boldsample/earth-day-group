...
const Privacy = () => {
  ...
  useEffect(() => {
    ...
    dispatch(setHeaderTitle('Privacy Policy'))
  }, [])
  ...
  return <div className="layout">
    ...
    <div className="main__content">
      <div className="about">
        ...
        <h4 className="mb-1 mt-3">Changes to This Privacy Policy</h4>
        ...
        <h4 className="mb-1 mt-3">How We Collect and Use Your Personal Information</h4>
        ...
        <h4 className="mb-1 mt-3">What Personal Information We Collect</h4>
        ...
        <h4 className="mb-1 mt-3">Information We Collect Directly from You</h4>
        ...
        <h4 className="mb-1 mt-3">Information We Collect through Cookies</h4>
        ...
        <h4 className="mb-1 mt-3">Information We Obtain from Third Parties</h4>
        ...
        <h4 className="mb-1 mt-3">How We Use Your Personal Information</h4>
        <ul>
        ...
        <h4 className="mb-1 mt-3">Cookies</h4>
        ...
        <h4 className="mb-1 mt-3">How We Disclose Personal Information</h4>
        ...
        <h4 className="mb-1 mt-3">User Generated Content</h4>
        ...
        <h4 className="mb-1 mt-3">Third Party Websites and Links</h4>
        ...
        <h4 className="mb-1 mt-3">Children's Data</h4>
        ...
        <h4 className="mb-1 mt-3">Security and Retention of Your Information</h4>
        ...
        <h4 className="mb-1 mt-3">Your Rights and Choices</h4>
        ...
        <h4 className="mb-1 mt-3">Complaints</h4>
        ...
        <h4 className="mb-1 mt-3">International Users</h4>
        ...
        <h4 className="mb-1 mt-3">Contact</h4>
        <p>Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you email us at earthdaygroup@outlook.com or contact us at 6761 Versailles ct, Lake Worth, FL, 33467, United States.</p>
